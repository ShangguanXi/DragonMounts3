...
public class DragonDefault3Model<T extends Entity> extends EntityModel<T> {
    ...
    private final ModelPart tailspine1;
    ...
    public DragonDefault3Model() {
        ...
        tailspine2 = new ModelPart(this);
        tailspine2.setPivot(0.0F, 0.0F, -9.0F);
        tailpart9.addChild(tailspine2);


        cube_r1 = new ModelPart(this);
        cube_r1.setPivot(0.0F, 0.0F, 0.0F);
        tailspine2.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.0F, -0.7854F, -0.1745F);
        cube_r1.setTextureOffset(0, 117).addCuboid(-2.0F, -1.5F, -1.0F, 3.0F, 3.0F, 32.0F, 0.0F, true);

        cube_r2 = new ModelPart(this);
        cube_r2.setPivot(0.0F, 0.0F, 0.0F);
        tailspine2.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.0F, 0.7854F, 0.1745F);
        cube_r2.setTextureOffset(0, 117).addCuboid(-1.0F, -1.5F, -1.0F, 3.0F, 3.0F, 32.0F, 0.0F, false);
        ...
        tailspine3 = new ModelPart(this);
        tailspine3.setPivot(0.0F, 0.0F, -8.0F);
        tailpart10.addChild(tailspine3);


        cube_r3 = new ModelPart(this);
        cube_r3.setPivot(0.0F, 0.0F, 0.0F);
        tailspine3.addChild(cube_r3);
        setRotationAngle(cube_r3, 0.0F, -0.7854F, -0.1745F);
        cube_r3.setTextureOffset(0, 117).addCuboid(-2.0F, -1.5F, -1.0F, 3.0F, 3.0F, 32.0F, 0.0F, true);

        cube_r4 = new ModelPart(this);
        cube_r4.setPivot(0.0F, 0.0F, 0.0F);
        tailspine3.addChild(cube_r4);
        setRotationAngle(cube_r4, 0.0F, 0.7854F, 0.1745F);
        cube_r4.setTextureOffset(0, 117).addCuboid(-1.0F, -1.5F, -1.0F, 3.0F, 3.0F, 32.0F, 0.0F, false);
        ...
        tailspine1 = new ModelPart(this);
        tailspine1.setPivot(0.0F, 0.0F, 0.0F);
        tailpart7.addChild(tailspine1);


        cube_r5 = new ModelPart(this);
        cube_r5.setPivot(0.0F, 0.0F, 0.0F);
        tailspine1.addChild(cube_r5);
        setRotationAngle(cube_r5, 0.0F, -0.7854F, -0.1745F);
        cube_r5.setTextureOffset(0, 117).addCuboid(-2.0F, -1.5F, -1.0F, 3.0F, 3.0F, 32.0F, 0.0F, true);

        cube_r6 = new ModelPart(this);
        cube_r6.setPivot(0.0F, 0.0F, 0.0F);
        tailspine1.addChild(cube_r6);
        setRotationAngle(cube_r6, 0.0F, 0.7854F, 0.1745F);
        cube_r6.setTextureOffset(0, 117).addCuboid(-1.0F, -1.5F, -1.0F, 3.0F, 3.0F, 32.0F, 0.0F, false);
        ...
        cube_r7.setTextureOffset(112, 0).addCuboid(-6.5F, 0.0F, -4.5F, 9.0F, 20.0F, 9.0F, 0.0F, false);
        ...
        cube_r8.setPivot(3.5F, -2.0F, 6.0F);
        leftfrontfoot.addChild(cube_r8);
        setRotationAngle(cube_r8, -0.1309F, 0.0F, 0.0F);
        cube_r8.setTextureOffset(210, 0).addCuboid(-4.5F, -3.0F, -7.0F, 9.0F, 4.0F, 8.0F, 0.0F, false);
        ...
        cube_r9.setTextureOffset(112, 0).addCuboid(-2.5F, 0.0F, -4.5F, 9.0F, 20.0F, 9.0F, 0.0F, true);
        ...
        cube_r10.setPivot(-3.5F, -2.0F, 6.0F);
        rightfrontfoot.addChild(cube_r10);
        setRotationAngle(cube_r10, -0.1309F, 0.0F, 0.0F);
        cube_r10.setTextureOffset(210, 0).addCuboid(-4.5F, -3.0F, -7.0F, 9.0F, 4.0F, 8.0F, 0.0F, true);
        ...
        cube_r11.setPivot(-2.5F, 30.0F, 2.5F);
        leftrearlegcombin.addChild(cube_r11);
        setRotationAngle(cube_r11, 1.5708F, 0.0F, 0.0F);
        cube_r11.setTextureOffset(152, 29).addCuboid(-1.5F, -6.0F, 3.5F, 7.0F, 16.0F, 7.0F, 0.0F, false);
        ...
        cube_r12.setPivot(2.5F, 30.0F, 2.5F);
        rightrearlegcombin.addChild(cube_r12);
        setRotationAngle(cube_r12, 1.5708F, 0.0F, 0.0F);
        cube_r12.setTextureOffset(152, 29).addCuboid(-5.5F, -6.0F, 3.5F, 7.0F, 16.0F, 7.0F, 0.0F, true);
